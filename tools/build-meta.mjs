...
- [NotionKit Elements](https://notionkit-elements.jungherz.com/): 79 vanilla-JS web components (\`<nk-*>\`) wrapping this markup – Shadow DOM, native forms, pixel parity. npm: \`@jungherz-de/notionkit-elements\`. AI reference: https://notionkit-elements.jungherz.com/SKILL.md
